...
//for($i=0;$i<count($hello);$i++){
	for($i=0;$i<0;$i++){
		$sql2 = "insert into class (cid,ctitle,start,end,cover_url,home_url,syllabus_url, modles_url,did,uid,day,ctext) values (".$cid.",'".$ctitle."',".$start.",".$end.",'".$cov_path."','".$home_path."','".$syl_path."','".$mod_path."')";
		try{	
